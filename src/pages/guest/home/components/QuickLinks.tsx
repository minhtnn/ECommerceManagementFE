            ...
            <div className="p-4 space-y-6 text-sm leading-relaxed">
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-2">
                  ...
                  trong Điều khoản mua bán hàng hóa này, vào bất cứ lúc nào.
                </p>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-3">
                  Khách hàng trả tiền mặt cho nhân viên giao hàng COD ngay khi
                  nhận được đơn hàng của mình. Chúng tôi chấp nhận hình thức
                  thanh toán khi nhận hàng (COD) cho tất cả các đơn hàng trên
                  toàn quốc.
                </p>
                <p className="text-muted-foreground mb-4">
                  Thanh toán khi giao hàng (COD) đơn hàng giá trị từ 0đ đến
                  2.500.000đ
                </p>

                <h4 className="font-semibold mb-2">Thanh toán chuyển khoản</h4>
                <p className="text-muted-foreground mb-3">
                  Khách hàng thực hiện chuyển khoản cho chúng tôi với đơn hàng
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-3">
                  <span className="font-medium">Phạm vi:</span> Giao hàng trên
                  toàn quốc
                </p>

                <h4 className="font-semibold mb-2">Chi phí vận chuyển</h4>
                <p className="text-muted-foreground mb-4">
                  Cước vận chuyển được tính dựa trên đơn hàng, địa chỉ giao hàng
                  và chương trình hỗ trợ vận chuyển được áp dụng từ nhà bán hàng
                  (nếu có); khách hàng chịu phí vận chuyển tính theo cước chuyển
                  phát của đơn vị cung cấp dịch vụ.
                </p>

                <h4 className="font-semibold mb-2">Thời gian giao hàng:</h4>
                <ul className="text-muted-foreground space-y-2 list-disc pl-5">
                  <li>
                    Đối với khách hàng tại nội thành TP Hồ Chí Minh, thời gian
                    giao hàng từ 2-4 ngày
                  </li>
                  <li>
                    Khách hàng ngoại thành TP HCM và các tỉnh thành khác, thời
                    gian giao hàng 5-7 ngày (tuỳ theo đơn vị vận chuyển)
                  </li>
                </ul>
                <p className="text-muted-foreground mt-3">
                  Trong trường hợp xảy ra sự cố khiến đơn hàng bị chậm trễ so
                  với thời gian giao dự kiến, chúng tôi sẽ thông báo tới quý
                  khách hàng.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-2">
                  Khi nhân viên giao nhận giao hàng, khách hàng có thể kiểm tra
                  sản phẩm và xác nhận với nhân viên tình trạng sản phẩm trước
                  khi thanh toán.
                </p>
                <p className="text-muted-foreground">
                  Với các sản phẩm vỡ, hỏng hóc, bị bóp méo, hoặc thiếu số
                  lượng, Khách hàng có thể báo lại nhân viên giao hàng và phản
                  hồi chúng tôi. Chúng tôi sẽ thực hiện chính sách đổi sản phẩm
                  nếu do lỗi của nhà sản xuất hoặc do lỗi của bên giao nhận.
                </p>
              </section>
              ...
              <section>
                <h3 className="font-bold text-base mb-3">
                  6. Trách nhiệm đối với bên cung cấp dịch vụ giao nhận
                </h3>
                <p className="text-muted-foreground mb-2">
                  Đối tác vận chuyển có trách nhiệm cung cấp dịch vụ vận chuyển
                  theo đúng yêu cầu, tiêu chuẩn dịch vụ đã đề ra và đã được thỏa
                  thuận trong hợp đồng hợp tác.
                </p>
                <p className="text-muted-foreground">
                  Đơn vị vận chuyển có trách nhiệm cung cấp các chứng từ liên
                  quan tới hàng hóa khi được yêu cầu bởi cơ quan quản lý nhà
                  nước có thẩm quyền trong quá trình thực hiện dịch vụ giao
                  nhận.
                </p>
              </section>
        ...
        <SheetContent side="right" className="w-full sm:max-w-lg p-0">
          ...
          <ScrollArea className="h-[calc(100vh-80px)]">
            <div className="p-4 space-y-6 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="font-bold text-base mb-3">
                  1. Giới thiệu chương trình khuyến mãi
                </h3>
                <p className="text-muted-foreground mb-2">
                  Chào mừng Quý khách hàng đến với các chương trình khuyến mãi
                  của Thái Kiên Coffee.
                </p>
                <p className="text-muted-foreground">
                  Chúng tôi thường xuyên tổ chức các chương trình ưu đãi đặc
                  biệt dành cho khách hàng thân thiết và khách hàng mới. Các
                  chương trình khuyến mãi được áp dụng theo từng thời điểm và có
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-3">
                  Áp dụng mức giảm giá trực tiếp trên giá bán sản phẩm. Mức giảm
                  có thể từ 5% đến 50% tùy theo chương trình và loại sản phẩm.
                </p>

                <h4 className="font-semibold mb-2">Mã giảm giá (Voucher)</h4>
                <p className="text-muted-foreground mb-3">
                  Khách hàng có thể sử dụng mã giảm giá khi thanh toán để được
                  hưởng ưu đãi. Mỗi mã giảm giá có điều kiện áp dụng riêng về
                  giá trị đơn hàng tối thiểu và thời hạn sử dụng.
                </p>

                <h4 className="font-semibold mb-2">Combo ưu đãi</h4>
                <p className="text-muted-foreground mb-3">
                  Mua combo sản phẩm với giá ưu đãi hơn so với mua lẻ từng sản
                  phẩm. Combo thường bao gồm các sản phẩm bổ trợ hoặc sản phẩm
                  cùng loại.
                </p>

                <h4 className="font-semibold mb-2">Quà tặng kèm</h4>
                <p className="text-muted-foreground">
                  Khi mua đơn hàng đạt giá trị nhất định, khách hàng sẽ được
                  tặng kèm quà hoặc sản phẩm miễn phí.
                </p>
              </section>
              ...
              <section>
                <h3 className="font-bold text-base mb-3">
                  3. Điều kiện áp dụng khuyến mãi
                </h3>
                <ul className="text-muted-foreground space-y-2 list-disc pl-5">
                  <li>
                    Mỗi đơn hàng chỉ được áp dụng một mã giảm giá duy nhất
                  </li>
                  <li>
                    Không áp dụng đồng thời nhiều chương trình khuyến mãi trừ
                    khi có thông báo cụ thể
                  </li>
                  <li>
                    Khuyến mãi không áp dụng cho đơn hàng đã thanh toán hoặc
                    đang trong quá trình giao hàng
                  </li>
                  <li>
                    Một số sản phẩm có thể không tham gia chương trình khuyến
                    mãi
                  </li>
                  <li>
                    Số lượng sản phẩm khuyến mãi có giới hạn và áp dụng theo thứ
                    tự đặt hàng
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-2">
                  Mỗi chương trình khuyến mãi có thời gian áp dụng riêng, được
                  thông báo rõ ràng trên website và các kênh truyền thông của
                  chúng tôi.
                </p>
                <p className="text-muted-foreground">
                  Chương trình khuyến mãi có thể kết thúc sớm hơn dự kiến nếu
                  hết số lượng ưu đãi hoặc theo quyết định của công ty.
                </p>
              </section>
              ...
              <section>
                <h3 className="font-bold text-base mb-3">
                  5. Chương trình Flash Sale
                </h3>
                <p className="text-muted-foreground mb-2">
                  Flash Sale là chương trình giảm giá đặc biệt trong thời gian
                  ngắn với mức ưu đãi hấp dẫn nhất.
                </p>
                <ul className="text-muted-foreground space-y-2 list-disc pl-5">
                  <li>
                    Thời gian diễn ra: Thường vào các khung giờ cố định trong
                    ngày
                  </li>
                  <li>
                    Số lượng giới hạn: Mỗi sản phẩm Flash Sale chỉ có số lượng
                    nhất định
                  </li>
              ...
              <section>
                <h3 className="font-bold text-base mb-3">
                  6. Chính sách hoàn tiền khuyến mãi
                </h3>
                <p className="text-muted-foreground mb-2">
                  Khi hoàn trả sản phẩm đã mua với giá khuyến mãi, số tiền hoàn
                  lại sẽ được tính theo giá đã thanh toán thực tế, không phải
                  giá gốc.
                </p>
                <p className="text-muted-foreground">
                  Mã giảm giá đã sử dụng sẽ không được hoàn lại sau khi đơn hàng
                  bị hủy hoặc hoàn trả.
                </p>
              </section>
