...
export const columns: ColumnDef<TPaymentMethodListResponse>[] = [
  {
      ...
      return (
        <div className="flex items-center gap-2 max-w-[180px]">
          ...
          <Button
            ...
            onClick={() => copyToClipboard(code, "Mã phương thức thanh toán")}
          >
  ...
  },
  {
    accessorKey: "name",
    header: ({ column }) =>
      createFormattedHeader("Tên phương thức", column, {
        sortable: true,
        className: "font-semibold text-base",
        align: "left",
      }),
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center">
          <TooltipProvider>
            <Tooltip>
              <Link to={PATH_SYSTEM_ADMIN_DASHBOARD.paymentMethod.edit(paymentMethod.id)}>
                <TooltipTrigger>
